...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const metaDescription = isFr
    ? `${name}${deviceText}. ${description}. +15'000 chaînes HD/4K, replay et VOD inclus. Activation en 2h, support 24/7. ${plan.price} CHF pour ${plan.duration} mois.`
    : `${name}${deviceText}. ${description}. +15'000 HD/4K-Kanäle, Replay und VOD inklusive. Aktivierung in 2h, 24/7 Support. ${plan.price} CHF für ${plan.duration} Monate.`;
