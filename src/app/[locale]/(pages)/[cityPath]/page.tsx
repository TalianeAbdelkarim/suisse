...
export default async function CityPage({ params }: Props) {
  ...
  const cityFaqs = isFr
    ? [
        { question: `Comment fonctionne IPTV Suisse à ${cityName} ?`, answer: `Notre service IPTV est disponible partout à ${cityName}. Il vous suffit d'une connexion internet de 10 Mbps minimum pour profiter de +15'000 chaînes HD/4K. Activation en moins de 2 heures.` },
    ...
    : [
        { question: `Wie funktioniert IPTV Schweiz in ${cityName}?`, answer: `Unser IPTV-Service ist überall in ${cityName} verfügbar. Sie benötigen lediglich eine Internetverbindung ab 10 Mbit/s für +15'000 HD/4K-Kanäle. Aktivierung in weniger als 2 Stunden.` },
