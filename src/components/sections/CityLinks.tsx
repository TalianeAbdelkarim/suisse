      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8">
        ...
        >
          <p className="text-xs text-text-muted">
            {locale === 'fr'
              ? 'Disponible aussi à Lugano, Biel/Bienne, Fribourg, Neuchâtel, Thun et dans toute la Suisse.'
              : 'Auch verfügbar in Lugano, Biel/Bienne, Freiburg, Neuenburg, Thun und in der gesamten Schweiz.'}
          </p>
        </motion.div>
      </div>
    </section>
